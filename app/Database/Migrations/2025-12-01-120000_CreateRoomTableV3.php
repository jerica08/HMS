...
class CreateRoomTableV3 extends Migration
{
    public function up()
    {
        $db = \Config\Database::connect();

        // Drop existing table if it exists (THIS WILL DELETE DATA)
        ...
        // Ensure InnoDB for FK support and proper timestamp defaults
