...
{
    protected string $table = 'medical_departments';
    ...
    public function up()
    {
        ...
        if ($db->tableExists('staff')) {
            $this->db->query(
                ...
                ' ADD CONSTRAINT fk_medical_dept_head_staff
    ...
    public function down()
    {
        ...
        try {
            $this->db->query('ALTER TABLE ' . $this->db->escapeString($this->table) . ' DROP FOREIGN KEY fk_medical_dept_head_staff');
        } catch (\Throwable $e) {
